...
class DeleteEnvelopDialogContent extends StatelessWidget {
  const DeleteEnvelopDialogContent({
    super.key,
  });
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Stack(
            children: [
              ...
              Align(
                ...
                child: AppText(
                  text: LocaleKeys.deleteEnvelope.tr(),
          ...
          12.sizeBoxH,
          AppText(
            text: LocaleKeys.deleteEnvelopeConfirmation.tr(),
          ...
          Row(
            children: [
              ...
              10.sizeBoxW,
              Expanded(child: AppButton(
                title: LocaleKeys.deleteEnvelope.tr(),
                onTap: () => context.pop(),
