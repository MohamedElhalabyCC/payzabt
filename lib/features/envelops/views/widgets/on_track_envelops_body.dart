  ...
  static final envelops = [
    {
      ...
      "color": Color(0xffFCE2A0),
      "title": LocaleKeys.food.tr(),
      "budget": 3000,
      "amount": 1500,
    },
    {
      "icon": Assets.imagesSvgCar,
      "color": Color(0xffDAF0F6),
      "title": LocaleKeys.transportation.tr(),
      "budget": 1200,
      "amount": 600,
    },
    {
      "icon": Assets.imagesSvgCircus,
      "color": Color(0xffDAF0F6),
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final double budget = (item["budget"] as num)
            .toDouble(); // 'num' covers both int and double
        ...
        return EnvelopProgressCard(
          ...
          bottom: index == envelops.length - 1 ? 120.h : 16.h,
          top: index == 0 ? 16.h : 0,
        );
      },
    );
